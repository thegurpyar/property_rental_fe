...
export default function CallToAction() {
  ...
  return (
    <section ref={sectionRef} className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-16 bg-white overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 sm:gap-14 md:gap-12 max-w-7xl mx-auto">
        ...
        <div className={`reveal-on-scroll ${isVisible ? 'animate-slide-left' : ''}`}>
          <Card className="group relative bg-[#0a1629] border-none rounded-[32px] sm:rounded-[40px] overflow-visible shadow-2xl transition-all duration-500 hover:scale-[1.02]">
            <CardContent className="p-6 sm:p-8 md:p-10 pb-16 sm:pb-18 md:pb-20 flex items-start gap-5 sm:gap-8">
              ...
              <div className="flex-1 pt-1 sm:pt-2">
                <h3 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-white mb-2 sm:mb-3 md:mb-4 tracking-tight">You need a house</h3>
              ...
              {/* Floating Button */}
              <Button className={`absolute -bottom-6 sm:-bottom-7 left-1/2 bg-[#FF7F32] hover:bg-orange-600 text-white h-auto px-6 sm:px-10 py-3.5 sm:py-5 rounded-xl sm:rounded-2xl font-black text-sm sm:text-base flex items-center gap-2 sm:gap-3 shadow-[0_20px_40px_-10px_rgba(255,127,50,0.5)] border-none transition-all active:scale-95 ${isVisible ? 'animate-cta-float' : '-translate-x-1/2'}`}>
        ...
        <div className={`reveal-on-scroll ${isVisible ? 'animate-slide-right delay-200' : ''}`}>
          <Card className="group relative bg-[#0a1629] border-none rounded-[32px] sm:rounded-[40px] overflow-visible shadow-2xl transition-all duration-500 hover:scale-[1.02]">
            <CardContent className="p-6 sm:p-8 md:p-10 pb-16 sm:pb-18 md:pb-20 flex items-start gap-5 sm:gap-8">
              ...
              <div className="flex-1 pt-1 sm:pt-2">
                <h3 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-white mb-2 sm:mb-3 md:mb-4 tracking-tight">Sell your house</h3>
                <p className="text-gray-400 text-xs sm:text-sm leading-relaxed font-medium">
